...
import com.rose.tiketku.Activities.RegisterTwoActivity;
import com.rose.tiketku.Activities.SuccessRegisterActivity;
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    storageReferences.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onComplete(@NonNull Task<Uri> task) {
                                            Intent gobackprofile = new Intent(EditProfile.this, ProfileActivity.class);
